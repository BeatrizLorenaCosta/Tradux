...
router.put('/documentos/:idEquipa/assinatura', verifyToken, verifyRole([3, 4]), async (req, res) => {
    const { idEquipa  } = req.params;
    const { conta_id, assinou_documento } = req.body;

    if (!idEquipa || !conta_id || typeof assinou_documento === 'undefined') {
