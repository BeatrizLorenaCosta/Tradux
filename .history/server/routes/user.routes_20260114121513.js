    ...
    try {
        const [rows] = await db.query(`
            SELECT 
                ...
                ru.id_conta AS responsavel_upload_id,
                ru.nome_utilizador AS responsavel_upload_nome,
                ru.email AS responsavel_upload_email
            ...
            LEFT JOIN contas ru ON ru.id_conta = ed_oposta.responsavel_upload_id
        ...
        rows.forEach(r => {
            ...
            if (r.id_documento && !documentosMap.has(r.id_documento)) {
                documentosMap.set(r.id_documento, {
                    ...
                    responsavel_upload: r.responsavel_upload_id ? {
                        id_conta: r.responsavel_upload_id,
                        nome_utilizador: r.responsavel_upload_nome,
                        email_responsavel: r.responsavel_upload_email,
                    } : null
                });
            }
        });
