...
async function abrirFormAssinatura(id, tipo) {
    ...
    if (tipo === 'revisores') {
        ...
        if (isResponsavel) {
            ...
            Se queres que o checkbox “Sem erros” desapareça (não só fique desativado), podes usar style.display = 'none'. Por exemplo, no teu JavaScript:
            ...
            checkboxSemErros.style.display = 'none';
            inputErros.value = documento.erros_encontrados || '';
            checkboxSemErros.checked = documento.erros_encontrados === null || documento.erros_encontrados === '';
