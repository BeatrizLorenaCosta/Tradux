...
async function carregarEquipa(tipo) {
    ...
    console.log(equipa);
    const tbody = document.querySelector(`#equipa-${tipo} table tbody`);
    const form = document.getElementById(`form-${tipo}`);
    console.log(equipa.nome_equipa);

    if (tipo === 'tradutores') {
        form.nome_equipa.value = equipa.nome_equipa;
        form.tipo_equipa.value = equipa.tipo;
        form.estado_equipa.value = equipa.tipo === 'tradutores' ? 'Ocupada' : 'Livre';
    }
...
async function carregarEquipaDocumentos(tipo) {
    const doc = await apiFetch('/api/users/me/equipa');
    console.log(equipa);
    const tbody = document.querySelector(`#equipa-${tipo} table tbody`);
    const form = document.getElementById(`form-${tipo}`);
    console.log(equipa.nome_equipa);
