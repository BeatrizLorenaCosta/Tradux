            ...
            equipa.documentos.map(d => {
                ...
                return `
                    <tr>
                        ...
                        <td>${d.paginas || '-'}</td>
                        <td>${d.equipa_oposta ? `${d.equipa_oposta.nome_equipa} (${d.responsavel_upload_oposta?.email  || 'Não tem responsavel'})`
                            : `Não tem equipa de ${tipo}`}</td>
                        <td>
                            <a href="${d.documento_link}" target="_blank" class="btn btn-sm btn-primary">Original</a>
                            ${d.documento_link_final ? ` <a href="${d.documento_link_final}" target="_blank" class="btn btn-sm btn-primary ms-1">Final</a>` : ''}
                        </td>
                    </tr>
                `;
            }),
