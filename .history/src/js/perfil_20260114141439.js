...
async function abrirFormAssinatura(id, btn, tipo) {
    ...
    let btnFechar = wrapper.querySelector('.btn-fechar-form');
    if (!btnFechar) {
        // Criar div container do botão
    const divWrapper = document.createElement('div');
    divWrapper.className = 'text-end mt-2';

    // Criar botão
    btnFechar = document.createElement('button');
    btnFechar.type = 'button';
    btnFechar.className = 'btn btn-secondary btn-sm btn-fechar-form';
    ...
    divWrapper.appendChild(btnFechar);

    // Adicionar div ao wrapper do form
...
function atualizarUploadBotao(documento, tipoEquipa, user) {
