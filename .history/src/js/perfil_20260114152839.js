...
function atualizarUploadBotao(documento, tipoEquipa, user) {
    ...
    console.log('tipo: ', tipoEquipa);
    console.log('id_conta: ', user.id_conta);
    console.log('responsavel_upload_atual_id: ', documento.responsavel_uploaconsole.log('responsavel_upload_atual_id: ', documento.responsavel_upload_atual_id);d_atual_id);
