document.addEventListener('DOMContentLoaded', () => {
    ...
    const toggleBtn = document.getElementById('toggle-form-tradutor');
    const formWrapper = document.getElementById('form-tradutor-wrapper');

    toggleBtn.addEventListener('click', () => {
        const aberto = formWrapper.style.display === 'block';

        formWrapper.style.display = aberto ? 'none' : 'block';
...
function setupToggle(btnId, wrapperId, textoAberto, textoFechado) {
    ...
    btn.addEventListener('click', () => {
        ...
        btn.textContent = aberto ? textoAberto : textoFechado;
    });
}

// Configurar todos os toggles
setupToggle('toggle-form-criar-equipa', 'form-criar-equipa-wrapper', '+ Criar Equipa', 'Fechar Formulário');
setupToggle('toggle-form-equipa-utilizador', 'form-equipa-utilizador-wrapper', '+ Adicionar Utilizador à Equipa', 'Fechar Formulário');
setupToggle('toggle-form-doc-equipa', 'form-doc-equipa-wrapper', '+ Associar Documento a Equipas', 'Fechar Formulário');
