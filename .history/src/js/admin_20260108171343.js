        ...
        documentos.forEach(doc => {
            ...
            tbody.innerHTML += `
                <tr>
                    ...
                    <td>${doc.valor + '€' || '—'}</td>
                    <td>
                        <button class="btn btn-sm btn-primary" onclick="abrirFormAlterarValor(${doc.id_documento}, this)">
                            Alterar Valor
                        </button>
...
function abrirFormAlterarValor(docId, button) {
    const wrapper = document.getElementById('form-valor-wrapper');
