...
function inicializarSidebar() {
    ...
    document.getElementById('userMenuToggle')?.addEventListener('click', () => {
        console.log('Chegou');
        if(document.getElementById('userSidebar').classList.contains('active')){
            document.getElementById('userSidebar').classList.rem('active');
        } else {
            document.getElementById('userSidebar').classList.add('active');
        }
        

        console.log(document.getElementById('userSidebar'));
    });
}
