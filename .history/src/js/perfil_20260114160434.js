...
async function abrirFormAssinatura(id, btn, tipo) {
    ...
    if (tipo === 'revisores') {
        ...
        // Só o responsável pode editar os erros
        ...
        if (isResponsavel) {
            ...
            // Ligar onchange do checkbox para limpar/atualizar input
            checkboxSemErros.onchange = () => {
                if (checkboxSemErros.checked) {
                    inputErros.value = '';
                    inputErros.disabled = true;
                } else {
                    inputErros.disabled = dfa;
                }
            };
        } else {
            // Membros que não são responsáveis só veem os erros e o estado do checkbox
            inputErros.disabled = true;
