...
// ===================== Menu dinâmico =====================
    const updateNavMenu = () => {
        ...
        if (user) {
            ...
            if (user.cargo_id === 1) {
                // deve mostrar Alterar dados, sair
            } else if (user.cargo_id === 3) { 
                // Tradutor deve mostrar: Alterar dados, Tradução (que tem sub items com: Equipa de traduçã (sessao), Documentos da equipa)(sessao), sair
                // Tradutor deve mostrar: Alterar dados, Tradução (que tem sub items com: Equipa de traduçã (sessao), Documentos da equipa), sair
