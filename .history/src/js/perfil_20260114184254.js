                ...
                return `
                    <tr>
                        ...
                        <td>
                            ...
                            ${d.estado === 'em_revisao' && d.documento_link_traduzido ? `
        ...
        if (isResponsavel) {
            ...
            btnValidar.onclick = async () => {
                ...
                if (checkbox) {
                   ...
                   const spanWrapper = li.querySelector('.tooltip-wrapper');
            if (spanWrapper) spanWrapper.title = '';
            ...
            if (m.id_conta === user.id_conta) {
                li.innerHTML = `
                    <div class="form-check">
                        <span class="tooltip-wrapper" title="${revisaoGuardada ? '' : 'É necessário guardar a revisão antes de assinar'}">
                ...
                checkbox.onchange = async () => {
                    if (!revisaoGuardada) {
                        alert("É necessário guardar a revisão antes de assinar!");
