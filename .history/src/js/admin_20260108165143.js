        ...
        users.forEach(user => {
            tbody.innerHTML += `
                <tr>
                    ...
                    <td>
                        <button id="toggle-form-alterar-cargo" class="btn btn-sm btn-primary" onclick="abrirFormAlterarCargo(${user.id_conta})">
                            Alterar Cargo
                        </button>
                        <button class="btn btn-sm btn-danger">
                            Eliminar Utilizador
...
document.getElementById('form-alterar-cargo')
    ?.addEventListener('submit', async e => {
        ...
        try {
            ...
            document.getElementById('toggle-form-alterar-cargo').textContent = 'Alterar Cargo';
        } catch (err) {
            console.error(err);
            alert(err.message);
        }
