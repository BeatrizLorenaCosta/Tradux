...
async function carregarEquipa() {
    try {
        ...
        formMembros.estado_equipa.value = equipa.ocupada === 'tradutores' ? 'Ocupada' : 'Livre';
        ...
        document.getElementById('estado_equipa2').value = equipa.ocupada === 'tradutores' ? 'Ocupada' : 'Livre';
