                ...
                return `
                    <tr>
                        ...
                        <td>
                            ...
                            ` : ''}
                            ${((d.estado === 'em_revisao' && tipo === 'revisores') || d.estado === 'aguardando_assinaturas' || (d.estado === 'em_traducao' && tipo === 'tradutores') || (d.estado === 'em_traducao' && tipo === 'tradutores') ) ? `
        ...
        membrosParaAssinatura.forEach(m => {
            ...
            if (m.id_conta === user.id_conta) {
                ...
                checkbox.onchange = async () => {
                    ...
                    if (tipo == 'revisores') msgRevisao.style.display = 'none';
