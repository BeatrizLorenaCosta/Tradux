                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button class="btn btn-sm btn-info ms-1"
                                onclick="abrirFormAssinaturaPorId(${d.id_documento}, '${tipo}')">
                                Assinar
                            </button>
                        </td>
                    </tr>
...
function abrirFormAssinaturaPorId(idDocumento, tipoEquipa) {
    const documento = userEquipa.documentos.find(d => d.id_documento === idDocumento);
    if (!documento) return;
